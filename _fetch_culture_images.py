#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 11 culture/philosophy techs.
Avoid portraits — pick artifacts, books, buildings, movements."""
...
TARGETS = [
    ("substrate-pluralism", "Mind uploading"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "culture/philosophy addition",
            }
