#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 7 new warfare techs (no portraits)."""
...
# Each target is an artifact / battle / object — never a portrait.
TARGETS = [
    ("linear-infantry-tactics",       "Line (formation)"),
    ("standardized-field-artillery",  "Gribeauval system"),
    ("ironclad-warship",              "HMS Warrior (1860)"),
    ("bolt-action-rifle",             "Mauser Model 1898"),
    ("high-explosives",               "Dynamite"),
    ("modern-quick-firing-artillery", "Canon de 75 modèle 1897"),
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "warfare addition",
            }
