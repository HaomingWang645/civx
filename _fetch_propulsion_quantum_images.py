#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 6 propulsion + quantum techs."""
...
TARGETS = [
    ("optical-atomic-clock",     "Optical lattice"),
    ("quantum-sensing",          "Nitrogen-vacancy center"),
    ("beamed-sail-propulsion",   "Breakthrough Starshot"),
    ("nuclear-pulse-propulsion", "Project Daedalus"),
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "propulsion/quantum addition",
            }
