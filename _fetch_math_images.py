#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 6 math frontier techs (no portraits)."""
...
TARGETS = [
    ("continuum-hypothesis-resolution","Cantor's diagonal argument"),
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "math frontier addition",
            }
