#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 3 SI-downstream techs (no portraits)."""
...
TARGETS = [
    ("whole-brain-emulation",      "Connectome"),
    ("knowledge-closure",          "Theory of everything"),
    ("subjective-time-compression","The Age of Em"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "SI-downstream addition",
            }
