#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 10 future/far-future weapons techs.
All targets are artifacts/programs/events — never personal portraits."""
...
# Each target is an object/program/event/instrument — explicitly NOT a person.
TARGETS = [
    ("self-replicating-combat-drones", "Lethal autonomous weapon"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "weapons addition",
            }
