#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 8 shelter / architecture techs."""
...
TARGETS = [
    ("smart-building", "Building information modeling"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "shelter addition",
            }
