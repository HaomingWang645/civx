...
window.TECH_UNLOCKS = {
  ...
  "chivalric-code": [
    { type: "work", name: "Song of Roland", name_zh: "《罗兰之歌》", wiki: "The Song of Roland" },
    { type: "person", name: "Geoffroi de Charny", name_zh: "若弗鲁瓦·德·沙尔尼", wiki: "Geoffroi de Charny" },
    { type: "work", name: "Book of the Order of Chivalry (Llull)", name_zh: "《骑士团之书》(柳利)", wiki: "Book of the Order of Chivalry" },
    { type: "org", name: "Order of the Garter", name_zh: "嘉德勋章团", wiki: "Order of the Garter" },
    { type: "unit", name: "Tournament (medieval)", name_zh: "中世纪马上比武大会", wiki: "Tournament (medieval)" },
  ],
  "mendicant-orders": [
    { type: "person", name: "Francis of Assisi", name_zh: "亚西西的方济各", wiki: "Francis of Assisi" },
    { type: "person", name: "Dominic de Guzmán", name_zh: "多明我·德古斯曼", wiki: "Dominic" },
    { type: "org", name: "Franciscans", name_zh: "方济各会", wiki: "Franciscans" },
    { type: "org", name: "Dominican Order", name_zh: "多明我会", wiki: "Dominican Order" },
    { type: "person", name: "Thomas Aquinas (Dominican)", name_zh: "托马斯·阿奎那", wiki: "Thomas Aquinas" },
    { type: "person", name: "Bonaventure (Franciscan)", name_zh: "波拿文都拉", wiki: "Bonaventure" },
  ],
  "courtly-love-romance": [
    { type: "person", name: "William IX of Aquitaine (first troubadour)", name_zh: "阿基坦的威廉九世", wiki: "William IX, Duke of Aquitaine" },
    { type: "person", name: "Chrétien de Troyes", name_zh: "克雷蒂安·德·特鲁瓦", wiki: "Chrétien de Troyes" },
    { type: "work", name: "Tristan and Iseult", name_zh: "《特里斯坦与伊索尔德》", wiki: "Tristan and Iseult" },
    { type: "work", name: "Le Roman de la Rose", name_zh: "《玫瑰传奇》", wiki: "Roman de la Rose" },
    { type: "work", name: "Lancelot, the Knight of the Cart", name_zh: "《兰斯洛特》", wiki: "Lancelot, the Knight of the Cart" },
    { type: "person", name: "Eleanor of Aquitaine", name_zh: "阿基坦的埃莉诺", wiki: "Eleanor of Aquitaine" },
  ],
  "plate-armor": [
  ...
  "public-sphere": [
    { type: "person", name: "Jürgen Habermas", name_zh: "尤尔根·哈贝马斯", wiki: "Jürgen Habermas" },
    { type: "work", name: "Structural Transformation of the Public Sphere", name_zh: "《公共领域的结构转型》", wiki: "The Structural Transformation of the Public Sphere" },
    { type: "wonder", name: "London coffeehouses", name_zh: "伦敦咖啡馆", wiki: "English coffeehouses in the 17th and 18th centuries" },
    { type: "org", name: "Royal Society", name_zh: "皇家学会", wiki: "Royal Society" },
    { type: "org", name: "French Academy of Sciences", name_zh: "法兰西科学院", wiki: "French Academy of Sciences" },
    { type: "work", name: "The Spectator (1711)", name_zh: "《观察者》(1711)", wiki: "The Spectator (1711)" },
    { type: "wonder", name: "Parisian salons", name_zh: "巴黎沙龙", wiki: "Salon (gathering)" },
  ],
  "novel": [
    { type: "person", name: "Daniel Defoe", name_zh: "丹尼尔·笛福", wiki: "Daniel Defoe" },
    { type: "person", name: "Samuel Richardson", name_zh: "塞缪尔·理查森", wiki: "Samuel Richardson" },
    { type: "person", name: "Henry Fielding", name_zh: "亨利·菲尔丁", wiki: "Henry Fielding" },
    { type: "work", name: "Robinson Crusoe", name_zh: "《鲁滨逊漂流记》", wiki: "Robinson Crusoe" },
    { type: "work", name: "Pamela; or, Virtue Rewarded", name_zh: "《帕梅拉,或贞洁有报》", wiki: "Pamela; or, Virtue Rewarded" },
    { type: "work", name: "Tom Jones", name_zh: "《汤姆·琼斯》", wiki: "The History of Tom Jones, a Foundling" },
    { type: "person", name: "Jane Austen", name_zh: "简·奥斯汀", wiki: "Jane Austen" },
  ],
  "abolitionism": [
    { type: "person", name: "Granville Sharp", name_zh: "格兰维尔·夏普", wiki: "Granville Sharp" },
    { type: "person", name: "Thomas Clarkson", name_zh: "托马斯·克拉克森", wiki: "Thomas Clarkson" },
    { type: "person", name: "William Wilberforce", name_zh: "威廉·威尔伯福斯", wiki: "William Wilberforce" },
    { type: "person", name: "Olaudah Equiano", name_zh: "奥劳达·艾奎亚诺", wiki: "Olaudah Equiano" },
    { type: "org", name: "Society for Effecting the Abolition of the Slave Trade", name_zh: "废除奴隶贸易协会", wiki: "Society for Effecting the Abolition of the Slave Trade" },
    { type: "work", name: "Slave Trade Act 1807", name_zh: "1807 年《废除奴隶贸易法案》", wiki: "Slave Trade Act 1807" },
    { type: "work", name: "Slavery Abolition Act 1833", name_zh: "1833 年《废奴法案》", wiki: "Slavery Abolition Act 1833" },
  ],
  "liberal-democracy": [
  ...
  "property-rights": [
    { type: "person", name: "John Locke", name_zh: "约翰·洛克", wiki: "John Locke" },
    { type: "work", name: "Two Treatises of Government", name_zh: "《政府论两篇》", wiki: "Two Treatises of Government" },
    { type: "work", name: "Bill of Rights 1689", name_zh: "1689 年《权利法案》", wiki: "Bill of Rights 1689" },
    { type: "work", name: "Code Napoléon", name_zh: "《拿破仑法典》", wiki: "Napoleonic Code" },
    { type: "work", name: "Takings Clause (Fifth Amendment)", name_zh: "美国宪法第五修正案征用条款", wiki: "Takings Clause" },
    { type: "person", name: "Hernando de Soto", name_zh: "赫尔南多·德·索托", wiki: "Hernando de Soto Polar" },
    { type: "work", name: "The Mystery of Capital", name_zh: "《资本的秘密》", wiki: "The Mystery of Capital" },
  ],
  "industrial-capitalism": [
    { type: "person", name: "Adam Smith", name_zh: "亚当·斯密", wiki: "Adam Smith" },
    { type: "work", name: "The Wealth of Nations", name_zh: "《国富论》", wiki: "The Wealth of Nations" },
    { type: "person", name: "David Ricardo", name_zh: "大卫·李嘉图", wiki: "David Ricardo" },
    { type: "work", name: "Comparative advantage", name_zh: "比较优势", wiki: "Comparative advantage" },
    { type: "person", name: "Jean-Baptiste Say", name_zh: "让-巴蒂斯特·萨伊", wiki: "Jean-Baptiste Say" },
    { type: "person", name: "John Stuart Mill", name_zh: "约翰·斯图尔特·密尔", wiki: "John Stuart Mill" },
    { type: "work", name: "Repeal of the Corn Laws (1846)", name_zh: "废除《谷物法》", wiki: "Corn Laws" },
    { type: "work", name: "Invisible hand", name_zh: "看不见的手", wiki: "Invisible hand" },
  ],
  ...
  "refrigeration": [
    { type: "person", name: "Carl von Linde", name_zh: "卡尔·冯·林德", wiki: "Carl von Linde" },
    { type: "person", name: "Willis Carrier", name_zh: "威利斯·开利", wiki: "Willis Carrier" },
    { type: "unit", name: "Vapor-compression cycle", name_zh: "蒸气压缩制冷循环", wiki: "Vapor-compression refrigeration" },
    { type: "resource", name: "Ammonia refrigerant", name_zh: "氨制冷剂", wiki: "Ammonia" },
    { type: "resource", name: "Freon", name_zh: "氟利昂", wiki: "Freon" },
  ...
  "game-theory": [
    { type: "person", name: "John von Neumann", name_zh: "约翰·冯·诺依曼", wiki: "John von Neumann" },
    { type: "person", name: "Oskar Morgenstern", name_zh: "奥斯卡·摩根斯特恩", wiki: "Oskar Morgenstern" },
    { type: "person", name: "John Forbes Nash Jr.", name_zh: "约翰·福布斯·纳什", wiki: "John Forbes Nash Jr." },
    { type: "person", name: "John Maynard Smith", name_zh: "约翰·梅纳德·史密斯", wiki: "John Maynard Smith" },
    { type: "work", name: "Theory of Games and Economic Behavior", name_zh: "《博弈论与经济行为》", wiki: "Theory of Games and Economic Behavior" },
    { type: "work", name: "Nash equilibrium", name_zh: "纳什均衡", wiki: "Nash equilibrium" },
    { type: "work", name: "Prisoner's dilemma", name_zh: "囚徒困境", wiki: "Prisoner's dilemma" },
    { type: "work", name: "Evolutionarily stable strategy", name_zh: "进化稳定策略", wiki: "Evolutionarily stable strategy" },
  ],
  "cryptanalysis-bombe": [
    { type: "person", name: "Alan Turing", name_zh: "艾伦·图灵" },
  ...
  "public-key-cryptography": [
    { type: "person", name: "Whitfield Diffie", name_zh: "惠特菲尔德·迪菲", wiki: "Whitfield Diffie" },
    { type: "person", name: "Martin Hellman", name_zh: "马丁·赫尔曼", wiki: "Martin Hellman" },
    { type: "person", name: "Ron Rivest", name_zh: "罗纳德·李维斯特", wiki: "Ron Rivest" },
    { type: "person", name: "Adi Shamir", name_zh: "阿迪·萨莫尔", wiki: "Adi Shamir" },
    { type: "person", name: "Leonard Adleman", name_zh: "伦纳德·阿德曼", wiki: "Leonard Adleman" },
    { type: "work", name: "RSA cryptosystem", name_zh: "RSA 加密算法", wiki: "RSA (cryptosystem)" },
    { type: "work", name: "Diffie–Hellman key exchange", name_zh: "Diffie–Hellman 密钥交换", wiki: "Diffie–Hellman key exchange" },
    { type: "work", name: "Elliptic-curve cryptography", name_zh: "椭圆曲线密码学", wiki: "Elliptic-curve cryptography" },
    { type: "work", name: "Transport Layer Security (TLS)", name_zh: "传输层安全协议", wiki: "Transport Layer Security" },
    { type: "work", name: "Pretty Good Privacy (PGP)", name_zh: "Pretty Good Privacy", wiki: "Pretty Good Privacy" },
  ],
  "search-engine": [
  ...
  "counter-stealth-radar": [
    { type: "unit", name: "Nebo-M radar", name_zh: "天空-M 雷达", wiki: "Nebo-M" },
    { type: "unit", name: "JY-26 radar", name_zh: "JY-26 雷达", wiki: "JY-26" },
    { type: "unit", name: "Vera passive sensor", name_zh: "薇拉无源探测系统", wiki: "Vera passive sensor" },
    { type: "work", name: "Passive radar", name_zh: "无源雷达", wiki: "Passive radar" },
    { type: "work", name: "VHF radar", name_zh: "甚高频雷达", wiki: "VHF radar" },
  ],
  "adaptive-cycle-engine": [
    { type: "unit", name: "GE XA100", name_zh: "通用电气 XA100 发动机", wiki: "General Electric XA100" },
    { type: "unit", name: "Pratt & Whitney XA101", name_zh: "普惠 XA101 发动机", wiki: "Pratt & Whitney XA101" },
    { type: "org", name: "Air Force Research Laboratory", name_zh: "美国空军研究实验室", wiki: "Air Force Research Laboratory" },
    { type: "work", name: "Variable cycle engine", name_zh: "变循环发动机", wiki: "Variable cycle engine" },
  ],
  "collaborative-combat-aircraft": [
    { type: "unit", name: "Anduril YFQ-44A Fury", name_zh: "Anduril 复仇女神无人机", wiki: "Anduril Fury" },
    { type: "unit", name: "General Atomics YFQ-42A", name_zh: "通用原子 YFQ-42A 无人机", wiki: "General Atomics YFQ-42" },
    { type: "unit", name: "Boeing MQ-28 Ghost Bat", name_zh: "波音 MQ-28 幽灵蝙蝠", wiki: "Boeing MQ-28 Ghost Bat" },
    { type: "unit", name: "Kratos XQ-58 Valkyrie", name_zh: "克拉托斯 XQ-58 女武神", wiki: "Kratos XQ-58 Valkyrie" },
    { type: "org", name: "Anduril Industries", name_zh: "Anduril 工业", wiki: "Anduril Industries" },
    { type: "work", name: "Manned-unmanned teaming", name_zh: "有人-无人协同", wiki: "Manned-unmanned teaming" },
  ],
  "sixth-gen-fighter": [
    { type: "unit", name: "Boeing F-47 (NGAD)", name_zh: "波音 F-47 (NGAD)", wiki: "Boeing F-47" },
    { type: "unit", name: "GCAP / Tempest", name_zh: "GCAP / 暴风战斗机", wiki: "Global Combat Air Programme" },
    { type: "unit", name: "FCAS / SCAF", name_zh: "FCAS 未来空战系统", wiki: "Future Combat Air System" },
    { type: "unit", name: "F/A-XX program", name_zh: "F/A-XX 计划", wiki: "F/A-XX program" },
    { type: "org", name: "USAF Next Generation Air Dominance", name_zh: "美国空军下一代空中优势", wiki: "Next Generation Air Dominance" },
  ],
  "cyber-warfare": [
  ...
  "fusion-power": [
    ...
    { type: "work", name: "Cold fusion (Fleischmann–Pons, 1989)", name_zh: "冷聚变(弗莱施曼-庞斯,1989)", wiki: "Cold fusion" },
  ],
  "humanoid-robot": [
  ...
  "mars-landing": [
    ...
    { type: "unit", name: "Starship", name_zh: "星舰", wiki: "SpaceX Starship" },
    { type: "person", name: "Elon Musk", name_zh: "埃隆·马斯克" },
    { type: "org", name: "NASA Mars Design Reference Architecture", name_zh: "NASA 火星设计参考架构", wiki: "Human mission to Mars" },
    { type: "person", name: "Robert Zubrin", name_zh: "罗伯特·祖布林", wiki: "Robert Zubrin" },
    { type: "unit", name: "Supersonic retropropulsion", name_zh: "超声速反推减速", wiki: "Supersonic retropropulsion" },
  ],
  "mars-habitat": [
    { type: "unit", name: "Sabatier reaction (ISRU)", name_zh: "萨巴蒂尔反应(原位资源利用)", wiki: "Sabatier reaction" },
    { type: "unit", name: "MOXIE oxygen generator", name_zh: "MOXIE 氧气发生器", wiki: "MOXIE" },
    { type: "resource", name: "Mars regolith", name_zh: "火星风化层", wiki: "Martian regolith" },
    { type: "resource", name: "Subsurface water ice", name_zh: "地下水冰", wiki: "Water on Mars" },
    { type: "unit", name: "3D-printed Mars habitat", name_zh: "3D 打印火星栖息地", wiki: "3D Printed Habitat Challenge" },
    { type: "person", name: "Jim Bridenstine", name_zh: "吉姆·布里登斯廷", wiki: "Jim Bridenstine" },
  ],
  "mars-colony": [
    { type: "wonder", name: "Olympus Mons", name_zh: "奥林帕斯山" },
    { type: "plant", name: "Mars potato (The Martian)", name_zh: "火星马铃薯", wiki: false },
    { type: "work", name: "The Case for Mars", name_zh: "《赶往火星》", wiki: "The Case for Mars" },
    { type: "wonder", name: "Valles Marineris", name_zh: "水手号峡谷", wiki: "Valles Marineris" },
    { type: "resource", name: "Martian methane fuel", name_zh: "火星甲烷燃料", wiki: "Methane economy" },
  ],
  "asteroid-mining": [
  ...
  "existentialism": [
    { type: "person", name: "Jean-Paul Sartre", name_zh: "让-保罗·萨特", wiki: "Jean-Paul Sartre" },
    { type: "person", name: "Simone de Beauvoir", name_zh: "西蒙娜·德·波伏娃", wiki: "Simone de Beauvoir" },
    { type: "person", name: "Albert Camus", name_zh: "阿尔贝·加缪", wiki: "Albert Camus" },
    { type: "person", name: "Martin Heidegger", name_zh: "马丁·海德格尔", wiki: "Martin Heidegger" },
    { type: "person", name: "Søren Kierkegaard", name_zh: "索伦·克尔凯郭尔", wiki: "Søren Kierkegaard" },
    { type: "work", name: "Being and Nothingness", name_zh: "《存在与虚无》", wiki: "Being and Nothingness" },
    { type: "work", name: "The Second Sex", name_zh: "《第二性》", wiki: "The Second Sex" },
    { type: "work", name: "The Myth of Sisyphus", name_zh: "《西西弗神话》", wiki: "The Myth of Sisyphus" },
    { type: "work", name: "The Stranger", name_zh: "《局外人》", wiki: "The Stranger (Camus novel)" },
  ],
  "rock-and-roll": [
    { type: "person", name: "Elvis Presley", name_zh: "猫王 (埃尔维斯·普雷斯利)", wiki: "Elvis Presley" },
    { type: "person", name: "Chuck Berry", name_zh: "查克·贝里", wiki: "Chuck Berry" },
    { type: "person", name: "Little Richard", name_zh: "小理查德", wiki: "Little Richard" },
    { type: "person", name: "Buddy Holly", name_zh: "巴迪·霍利", wiki: "Buddy Holly" },
    { type: "org", name: "The Beatles", name_zh: "披头士乐队", wiki: "The Beatles" },
    { type: "org", name: "The Rolling Stones", name_zh: "滚石乐队", wiki: "The Rolling Stones" },
    { type: "wonder", name: "Woodstock Festival", name_zh: "伍德斯托克音乐节", wiki: "Woodstock" },
    { type: "work", name: "British Invasion", name_zh: "不列颠入侵", wiki: "British Invasion" },
  ],
  "suburbanization": [
    { type: "wonder", name: "Levittown, New York", name_zh: "纽约莱维敦", wiki: "Levittown, New York" },
    { type: "person", name: "William Levitt", name_zh: "威廉·莱维特", wiki: "William Levitt" },
    { type: "work", name: "Federal Housing Administration", name_zh: "联邦住房管理局", wiki: "Federal Housing Administration" },
    { type: "work", name: "GI Bill (housing provisions)", name_zh: "《退伍军人权利法案》", wiki: "G.I. Bill" },
    { type: "work", name: "Redlining", name_zh: "红线政策", wiki: "Redlining" },
    { type: "resource", name: "Single-family detached home", name_zh: "独栋住宅", wiki: "Single-family detached home" },
  ],
  "mass-higher-education": [
    { type: "work", name: "G.I. Bill (1944)", name_zh: "1944 年《退伍军人权利法案》", wiki: "G.I. Bill" },
    { type: "work", name: "Higher Education Act of 1965", name_zh: "1965 年《高等教育法》", wiki: "Higher Education Act of 1965" },
    { type: "work", name: "California Master Plan for Higher Education", name_zh: "加州高等教育总体规划", wiki: "California Master Plan for Higher Education" },
    { type: "work", name: "Robbins Report", name_zh: "罗宾斯报告", wiki: "Robbins Report" },
    { type: "org", name: "Land-grant university", name_zh: "赠地大学", wiki: "Land-grant university" },
    { type: "person", name: "Clark Kerr", name_zh: "克拉克·克尔", wiki: "Clark Kerr" },
  ],
  "postmodernism": [
    { type: "person", name: "Jean-François Lyotard", name_zh: "让-弗朗索瓦·利奥塔", wiki: "Jean-François Lyotard" },
    { type: "person", name: "Jacques Derrida", name_zh: "雅克·德里达", wiki: "Jacques Derrida" },
    { type: "person", name: "Michel Foucault", name_zh: "米歇尔·福柯", wiki: "Michel Foucault" },
    { type: "person", name: "Richard Rorty", name_zh: "理查德·罗蒂", wiki: "Richard Rorty" },
    { type: "work", name: "The Postmodern Condition", name_zh: "《后现代状况》", wiki: "The Postmodern Condition" },
    { type: "work", name: "Of Grammatology", name_zh: "《论文字学》", wiki: "Of Grammatology" },
    { type: "work", name: "Discipline and Punish", name_zh: "《规训与惩罚》", wiki: "Discipline and Punish" },
    { type: "person", name: "Thomas Pynchon", name_zh: "托马斯·品钦", wiki: "Thomas Pynchon" },
    { type: "work", name: "Postmodern architecture", name_zh: "后现代建筑", wiki: "Postmodern architecture" },
  ],
  "cybernetics": [
    { type: "person", name: "Norbert Wiener", name_zh: "诺伯特·维纳", wiki: "Norbert Wiener" },
    { type: "person", name: "Claude Shannon", name_zh: "克劳德·香农", wiki: "Claude Shannon" },
  ...
  "globalization": [
    { type: "org", name: "World Trade Organization", name_zh: "世界贸易组织", wiki: "World Trade Organization" },
    { type: "work", name: "Bretton Woods Conference", name_zh: "布雷顿森林会议", wiki: "Bretton Woods Conference" },
    { type: "work", name: "GATT (General Agreement on Tariffs and Trade)", name_zh: "《关税及贸易总协定》", wiki: "General Agreement on Tariffs and Trade" },
    { type: "work", name: "NAFTA", name_zh: "《北美自由贸易协定》", wiki: "North American Free Trade Agreement" },
    { type: "work", name: "European Single Market", name_zh: "欧洲单一市场", wiki: "European Single Market" },
    { type: "work", name: "China's WTO accession", name_zh: "中国加入世贸组织", wiki: "Accession of China to the World Trade Organization" },
    { type: "person", name: "Thomas Friedman", name_zh: "托马斯·弗里德曼", wiki: "Thomas Friedman" },
    { type: "work", name: "The World Is Flat", name_zh: "《世界是平的》", wiki: "The World Is Flat" },
  ],
  "degrowth-economics": [
  ...
  "realism-naturalism": [
    { type: "person", name: "Charles Dickens", name_zh: "查尔斯·狄更斯", wiki: "Charles Dickens" },
    { type: "person", name: "Honoré de Balzac", name_zh: "奥诺雷·德·巴尔扎克", wiki: "Honoré de Balzac" },
    { type: "person", name: "Gustave Flaubert", name_zh: "古斯塔夫·福楼拜", wiki: "Gustave Flaubert" },
    { type: "person", name: "Leo Tolstoy", name_zh: "列夫·托尔斯泰", wiki: "Leo Tolstoy" },
    { type: "person", name: "Fyodor Dostoyevsky", name_zh: "陀思妥耶夫斯基", wiki: "Fyodor Dostoevsky" },
    { type: "person", name: "Émile Zola", name_zh: "埃米尔·左拉", wiki: "Émile Zola" },
    { type: "work", name: "Madame Bovary", name_zh: "《包法利夫人》", wiki: "Madame Bovary" },
    { type: "work", name: "War and Peace", name_zh: "《战争与和平》", wiki: "War and Peace" },
    { type: "work", name: "Middlemarch", name_zh: "《米德尔马契》", wiki: "Middlemarch" },
  ],
  "spectator-sports": [
    { type: "org", name: "Football Association", name_zh: "英格兰足球协会", wiki: "The Football Association" },
    { type: "work", name: "Laws of Cricket", name_zh: "《板球规则》", wiki: "Laws of Cricket" },
    { type: "org", name: "National League (baseball)", name_zh: "美国职业棒球国家联盟", wiki: "National League" },
    { type: "org", name: "FIFA World Cup", name_zh: "国际足联世界杯", wiki: "FIFA World Cup" },
    { type: "wonder", name: "Wembley Stadium", name_zh: "温布利球场", wiki: "Wembley Stadium" },
    { type: "wonder", name: "Yankee Stadium", name_zh: "扬基体育场", wiki: "Yankee Stadium" },
  ],
  "modern-retail": [
    { type: "org", name: "Le Bon Marché", name_zh: "乐蓬马歇百货", wiki: "Le Bon Marché" },
    { type: "org", name: "Macy's", name_zh: "梅西百货", wiki: "Macy's" },
    { type: "org", name: "Selfridges", name_zh: "塞尔福里奇百货", wiki: "Selfridges" },
    { type: "org", name: "Marshall Field's", name_zh: "马歇尔·菲尔德百货", wiki: "Marshall Field's" },
    { type: "person", name: "Aristide Boucicaut", name_zh: "阿里斯蒂德·布西科", wiki: "Aristide Boucicaut" },
    { type: "work", name: "Au Bonheur des Dames (Zola)", name_zh: "《妇女乐园》(左拉)", wiki: "Au Bonheur des Dames" },
  ],
  "mass-tourism": [
    { type: "person", name: "Thomas Cook", name_zh: "托马斯·库克", wiki: "Thomas Cook (entrepreneur)" },
    { type: "org", name: "Thomas Cook & Son", name_zh: "托马斯·库克父子公司", wiki: "Thomas Cook & Son" },
    { type: "person", name: "Karl Baedeker", name_zh: "卡尔·贝德克尔", wiki: "Karl Baedeker" },
    { type: "work", name: "Baedeker guidebook", name_zh: "《贝德克尔旅行指南》", wiki: "Baedeker" },
    { type: "work", name: "Grand Tour", name_zh: "壮游", wiki: "Grand Tour" },
    { type: "work", name: "Package holiday", name_zh: "包价旅游", wiki: "Package holiday" },
  ],
  "civil-aviation": [
  ...
  // ─── Realism Audit additions ───
  "electric-generator": [
    { type: "person", name: "Hippolyte Pixii", name_zh: "希波利特·皮克西", wiki: "Hippolyte Pixii" },
    { type: "person", name: "Werner von Siemens", name_zh: "维尔纳·冯·西门子", wiki: "Werner von Siemens" },
    { type: "person", name: "Zénobe Gramme", name_zh: "泽诺布·格拉姆", wiki: "Zénobe Gramme" },
    { type: "monument", name: "Pearl Street Station", name_zh: "珍珠街发电站", wiki: "Pearl Street Station" },
    { type: "resource", name: "Dynamo", name_zh: "直流发电机", wiki: "Dynamo" },
  ],
  "stethoscope": [
    { type: "person", name: "René Laennec", name_zh: "勒内·雷奈克", wiki: "René Laennec" },
    { type: "creative", name: "De l'auscultation médiate", name_zh: "《间接听诊法》", wiki: "De l'Auscultation Médiate" },
    { type: "resource", name: "Auscultation", name_zh: "听诊", wiki: "Auscultation" },
  ],
  "endocrinology": [
    { type: "person", name: "Paul Langerhans", name_zh: "保罗·朗格汉斯", wiki: "Paul Langerhans" },
    { type: "person", name: "Oskar Minkowski", name_zh: "奥斯卡·闵可夫斯基", wiki: "Oskar Minkowski" },
    { type: "person", name: "Ernest Starling", name_zh: "欧内斯特·斯塔林", wiki: "Ernest Starling" },
    { type: "resource", name: "Hormone", name_zh: "激素", wiki: "Hormone" },
    { type: "resource", name: "Islets of Langerhans", name_zh: "胰岛", wiki: "Pancreatic islets" },
  ],
  "synthetic-pharmaceuticals": [
    { type: "person", name: "Felix Hoffmann", name_zh: "费利克斯·霍夫曼", wiki: "Felix Hoffmann" },
    { type: "person", name: "Paul Ehrlich", name_zh: "保罗·埃尔利希", wiki: "Paul Ehrlich" },
    { type: "org", name: "Bayer", name_zh: "拜耳", wiki: "Bayer" },
    { type: "resource", name: "Aspirin", name_zh: "阿司匹林", wiki: "Aspirin" },
    { type: "resource", name: "Salvarsan", name_zh: "撒尔佛散", wiki: "Arsphenamine" },
    { type: "resource", name: "Sulfa drugs", name_zh: "磺胺类药物", wiki: "Sulfonamide (medicine)" },
  ],
  "blood-typing": [
    { type: "person", name: "Karl Landsteiner", name_zh: "卡尔·兰德施泰纳", wiki: "Karl Landsteiner" },
    { type: "resource", name: "ABO blood group system", name_zh: "ABO血型系统", wiki: "ABO blood group system" },
    { type: "resource", name: "Rh factor", name_zh: "Rh血型系统", wiki: "Rh blood group system" },
    { type: "resource", name: "Blood transfusion", name_zh: "输血", wiki: "Blood transfusion" },
    { type: "org", name: "Blood bank", name_zh: "血库", wiki: "Blood bank" },
  ],
  "celestial-navigation": [
    { type: "resource", name: "Polynesian navigation", name_zh: "波利尼西亚航海", wiki: "Polynesian navigation" },
    { type: "person", name: "Hipparchus", name_zh: "喜帕恰斯", wiki: "Hipparchus" },
    { type: "resource", name: "Polaris", name_zh: "北极星", wiki: "Polaris" },
    { type: "resource", name: "Latitude", name_zh: "纬度", wiki: "Latitude" },
    { type: "unit", name: "Wayfinder", name_zh: "波利尼西亚领航员", wiki: "Wayfinding" },
  ],
  "portland-cement": [
    { type: "person", name: "Joseph Aspdin", name_zh: "约瑟夫·阿斯普丁", wiki: "Joseph Aspdin" },
    { type: "person", name: "Frederick Ransome", name_zh: "弗雷德里克·兰塞姆", wiki: "Frederick Ransome" },
    { type: "resource", name: "Clinker", name_zh: "水泥熟料", wiki: "Clinker (cement)" },
    { type: "resource", name: "Rotary kiln", name_zh: "回转窑", wiki: "Rotary kiln" },
  ],
  "vulcanized-rubber": [
    { type: "person", name: "Charles Goodyear", name_zh: "查尔斯·固特异", wiki: "Charles Goodyear" },
    { type: "person", name: "John Boyd Dunlop", name_zh: "约翰·邓禄普", wiki: "John Boyd Dunlop" },
    { type: "resource", name: "Vulcanization", name_zh: "硫化", wiki: "Vulcanization" },
    { type: "resource", name: "Pneumatic tire", name_zh: "充气轮胎", wiki: "Pneumatic tire" },
    { type: "plant", name: "Hevea brasiliensis", name_zh: "巴西橡胶树", wiki: "Hevea brasiliensis" },
  ],
  "ac-power-transformer": [
    { type: "person", name: "William Stanley Jr.", name_zh: "小威廉·斯坦利", wiki: "William Stanley Jr." },
    { type: "person", name: "Nikola Tesla", name_zh: "尼古拉·特斯拉", wiki: "Nikola Tesla" },
    { type: "person", name: "George Westinghouse", name_zh: "乔治·威斯汀豪斯", wiki: "George Westinghouse" },
    { type: "monument", name: "Niagara Falls power station", name_zh: "尼亚加拉发电站", wiki: "Adams Power Plant Transformer House" },
    { type: "resource", name: "Transformer", name_zh: "变压器", wiki: "Transformer" },
    { type: "resource", name: "War of the Currents", name_zh: "电流战争", wiki: "War of the currents" },
  ],
  "relational-database": [
    { type: "person", name: "Edgar F. Codd", name_zh: "埃德加·科德", wiki: "Edgar F. Codd" },
    { type: "person", name: "Larry Ellison", name_zh: "拉里·埃里森", wiki: "Larry Ellison" },
    { type: "org", name: "Oracle", name_zh: "甲骨文公司", wiki: "Oracle Corporation" },
    { type: "resource", name: "SQL", name_zh: "SQL结构化查询语言", wiki: "SQL" },
    { type: "resource", name: "ACID transactions", name_zh: "ACID事务", wiki: "ACID" },
    { type: "resource", name: "PostgreSQL", name_zh: "PostgreSQL", wiki: "PostgreSQL" },
  ],
  "hard-disk-drive": [
    { type: "org", name: "IBM", name_zh: "IBM", wiki: "IBM" },
    { type: "monument", name: "IBM RAMAC 305", name_zh: "IBM RAMAC 305", wiki: "IBM 305 RAMAC" },
    { type: "resource", name: "Giant magnetoresistance", name_zh: "巨磁阻效应", wiki: "Giant magnetoresistance" },
    { type: "resource", name: "Perpendicular recording", name_zh: "垂直磁记录", wiki: "Perpendicular recording" },
  ],
  "dram-memory": [
    { type: "person", name: "Robert Dennard", name_zh: "罗伯特·登纳德", wiki: "Robert H. Dennard" },
    { type: "monument", name: "Intel 1103", name_zh: "Intel 1103", wiki: "Intel 1103" },
    { type: "org", name: "Samsung Semiconductor", name_zh: "三星半导体", wiki: "Samsung Semiconductor" },
    { type: "org", name: "SK Hynix", name_zh: "SK海力士", wiki: "SK Hynix" },
    { type: "org", name: "Micron Technology", name_zh: "美光科技", wiki: "Micron Technology" },
  ],
  "flash-memory": [
    { type: "person", name: "Fujio Masuoka", name_zh: "舛冈富士雄", wiki: "Fujio Masuoka" },
    { type: "org", name: "Toshiba", name_zh: "东芝", wiki: "Toshiba" },
    { type: "resource", name: "NAND flash", name_zh: "NAND闪存", wiki: "Flash memory" },
    { type: "resource", name: "Solid-state drive", name_zh: "固态硬盘", wiki: "Solid-state drive" },
    { type: "resource", name: "USB flash drive", name_zh: "USB闪存盘", wiki: "USB flash drive" },
  ],
  "photolithography": [
    { type: "person", name: "Jay Lathrop", name_zh: "杰伊·拉斯罗普", wiki: "Jay W. Lathrop" },
    { type: "resource", name: "Photoresist", name_zh: "光刻胶", wiki: "Photoresist" },
    { type: "resource", name: "Photomask", name_zh: "光掩模", wiki: "Photomask" },
    { type: "resource", name: "Moore's Law", name_zh: "摩尔定律", wiki: "Moore's law" },
  ],
  "wafer-stepper": [
    { type: "org", name: "ASML", name_zh: "阿斯麦", wiki: "ASML Holding" },
    { type: "org", name: "GCA Corporation", name_zh: "GCA 公司", wiki: "GCA Corporation" },
    { type: "person", name: "Burn Lin", name_zh: "林本坚", wiki: "Burn J. Lin" },
    { type: "resource", name: "Excimer laser", name_zh: "准分子激光", wiki: "Excimer laser" },
    { type: "resource", name: "Immersion lithography", name_zh: "浸润式光刻", wiki: "Immersion lithography" },
    { type: "resource", name: "Numerical aperture", name_zh: "数值孔径", wiki: "Numerical aperture" },
  ],

  // ─── Mechanics & Aerodynamics ───
  "statics-strength": [
    { type: "person", name: "Galileo Galilei", name_zh: "伽利略·伽利雷", wiki: "Galileo Galilei" },
    { type: "person", name: "Robert Hooke", name_zh: "罗伯特·胡克", wiki: "Robert Hooke" },
    { type: "person", name: "Leonhard Euler", name_zh: "莱昂哈德·欧拉", wiki: "Leonhard Euler" },
    { type: "person", name: "Augustin-Louis Cauchy", name_zh: "奥古斯丁-路易·柯西", wiki: "Augustin-Louis Cauchy" },
    { type: "creative", name: "Two New Sciences", name_zh: "《关于两门新科学的对话》", wiki: "Two New Sciences" },
    { type: "resource", name: "Hooke's law", name_zh: "胡克定律", wiki: "Hooke's law" },
    { type: "resource", name: "Euler-Bernoulli beam theory", name_zh: "欧拉-伯努利梁理论", wiki: "Euler–Bernoulli beam theory" },
    { type: "resource", name: "Cauchy stress tensor", name_zh: "柯西应力张量", wiki: "Cauchy stress tensor" },
  ],
  "fluid-dynamics": [
    { type: "person", name: "Daniel Bernoulli", name_zh: "丹尼尔·伯努利", wiki: "Daniel Bernoulli" },
    { type: "person", name: "Leonhard Euler", name_zh: "莱昂哈德·欧拉", wiki: "Leonhard Euler" },
    { type: "person", name: "Claude-Louis Navier", name_zh: "克劳德-路易·纳维", wiki: "Claude-Louis Navier" },
    { type: "person", name: "George Stokes", name_zh: "乔治·斯托克斯", wiki: "George Gabriel Stokes" },
    { type: "creative", name: "Hydrodynamica", name_zh: "《流体动力学》", wiki: "Hydrodynamica" },
    { type: "resource", name: "Bernoulli's principle", name_zh: "伯努利原理", wiki: "Bernoulli's principle" },
    { type: "resource", name: "Euler equations", name_zh: "欧拉方程(流体)", wiki: "Euler equations (fluid dynamics)" },
    { type: "resource", name: "Navier–Stokes equations", name_zh: "纳维-斯托克斯方程", wiki: "Navier–Stokes equations" },
    { type: "resource", name: "Reynolds number", name_zh: "雷诺数", wiki: "Reynolds number" },
  ],
  "aerodynamics": [
    { type: "person", name: "Ludwig Prandtl", name_zh: "路德维希·普朗特", wiki: "Ludwig Prandtl" },
    { type: "person", name: "Frederick Lanchester", name_zh: "弗雷德里克·兰彻斯特", wiki: "Frederick W. Lanchester" },
    { type: "person", name: "Theodore von Kármán", name_zh: "西奥多·冯·卡门", wiki: "Theodore von Kármán" },
    { type: "person", name: "Nikolai Joukowsky", name_zh: "尼古拉·茹科夫斯基", wiki: "Nikolay Zhukovsky (scientist)" },
    { type: "resource", name: "Boundary layer", name_zh: "边界层", wiki: "Boundary layer" },
    { type: "resource", name: "Kutta–Joukowsky theorem", name_zh: "库塔-茹科夫斯基定理", wiki: "Kutta–Joukowski theorem" },
    { type: "resource", name: "Airfoil", name_zh: "翼型", wiki: "Airfoil" },
    { type: "resource", name: "Lift (force)", name_zh: "升力", wiki: "Lift (force)" },
    { type: "resource", name: "Kármán vortex street", name_zh: "卡门涡街", wiki: "Kármán vortex street" },
  ],

  // ─── Compact-Object Astrophysics ───
  "stellar-evolution": [
    { type: "person", name: "Ejnar Hertzsprung", name_zh: "埃希纳·赫茨普龙", wiki: "Ejnar Hertzsprung" },
    { type: "person", name: "Henry Norris Russell", name_zh: "亨利·诺里斯·罗素", wiki: "Henry Norris Russell" },
    { type: "person", name: "Arthur Eddington", name_zh: "阿瑟·爱丁顿", wiki: "Arthur Eddington" },
    { type: "person", name: "Hans Bethe", name_zh: "汉斯·贝特", wiki: "Hans Bethe" },
    { type: "creative", name: "B²FH paper", name_zh: "B²FH论文(恒星核合成)", wiki: "B²FH paper" },
    { type: "resource", name: "Hertzsprung–Russell diagram", name_zh: "赫罗图", wiki: "Hertzsprung–Russell diagram" },
    { type: "resource", name: "Main sequence", name_zh: "主序", wiki: "Main sequence" },
    { type: "resource", name: "Stellar nucleosynthesis", name_zh: "恒星核合成", wiki: "Stellar nucleosynthesis" },
  ],
  "pulsars-neutron-stars": [
    { type: "person", name: "Jocelyn Bell Burnell", name_zh: "乔斯林·贝尔·伯内尔", wiki: "Jocelyn Bell Burnell" },
    { type: "person", name: "Antony Hewish", name_zh: "安东尼·休伊什", wiki: "Antony Hewish" },
    { type: "person", name: "Subrahmanyan Chandrasekhar", name_zh: "苏布拉马尼扬·钱德拉塞卡", wiki: "Subrahmanyan Chandrasekhar" },
    { type: "person", name: "Fritz Zwicky", name_zh: "弗里茨·兹威基", wiki: "Fritz Zwicky" },
    { type: "monument", name: "Crab Pulsar", name_zh: "蟹状星云脉冲星", wiki: "Crab Pulsar" },
    { type: "resource", name: "Chandrasekhar limit", name_zh: "钱德拉塞卡极限", wiki: "Chandrasekhar limit" },
    { type: "resource", name: "Magnetar", name_zh: "磁星", wiki: "Magnetar" },
    { type: "resource", name: "Neutron-star equation of state", name_zh: "中子星状态方程", wiki: "Neutron star" },
  ],
  "kilonova-merger": [
    { type: "monument", name: "GW170817", name_zh: "GW170817事件", wiki: "GW170817" },
    { type: "monument", name: "GRB 170817A", name_zh: "GRB 170817A伽玛暴", wiki: "GRB 170817A" },
    { type: "org", name: "LIGO", name_zh: "激光干涉引力波天文台", wiki: "LIGO" },
    { type: "org", name: "Virgo interferometer", name_zh: "Virgo干涉仪", wiki: "Virgo interferometer" },
    { type: "resource", name: "Kilonova", name_zh: "千新星", wiki: "Kilonova" },
    { type: "resource", name: "R-process", name_zh: "r过程核合成", wiki: "R-process" },
    { type: "resource", name: "Multi-messenger astronomy", name_zh: "多信使天文学", wiki: "Multi-messenger astronomy" },
    { type: "resource", name: "Short gamma-ray burst", name_zh: "短伽玛暴", wiki: "Gamma-ray burst" },
  ],
  "pulsar-navigation": [
    { type: "monument", name: "NICER (ISS X-ray telescope)", name_zh: "NICER国际空间站X射线望远镜", wiki: "Neutron star Interior Composition Explorer" },
    { type: "unit", name: "SEXTANT experiment", name_zh: "SEXTANT脉冲星导航实验", wiki: "Neutron star Interior Composition Explorer" },
    { type: "resource", name: "Millisecond pulsar", name_zh: "毫秒脉冲星", wiki: "Millisecond pulsar" },
    { type: "resource", name: "Pioneer plaque (pulsar map)", name_zh: "先驱者镀金铝板(脉冲星地图)", wiki: "Pioneer plaque" },
    { type: "org", name: "NASA Goddard", name_zh: "NASA戈达德太空飞行中心", wiki: "Goddard Space Flight Center" },
  ],
  "pulsar-timing-array": [
    { type: "org", name: "NANOGrav", name_zh: "NANOGrav联合体", wiki: "North American Nanohertz Observatory for Gravitational Waves" },
    { type: "org", name: "European Pulsar Timing Array", name_zh: "欧洲脉冲星计时阵列", wiki: "European Pulsar Timing Array" },
    { type: "org", name: "Parkes Pulsar Timing Array", name_zh: "帕克斯脉冲星计时阵列", wiki: "Parkes Pulsar Timing Array" },
    { type: "resource", name: "Hellings-Downs correlation", name_zh: "Hellings-Downs相关函数", wiki: "Hellings–Downs curve" },
    { type: "resource", name: "Stochastic gravitational-wave background", name_zh: "随机引力波背景", wiki: "Stochastic gravitational wave background" },
    { type: "resource", name: "Supermassive black-hole binary", name_zh: "超大质量黑洞双星", wiki: "Binary black hole" },
  ],
  "r-process-astromining": [
    { type: "resource", name: "Kilonova ejecta", name_zh: "千新星抛射物", wiki: "Kilonova" },
    { type: "resource", name: "Supernova remnant", name_zh: "超新星遗迹", wiki: "Supernova remnant" },
    { type: "resource", name: "Platinum-group metals", name_zh: "铂系元素", wiki: "Platinum group" },
    { type: "resource", name: "Rare-earth element", name_zh: "稀土元素", wiki: "Rare-earth element" },
    { type: "unit", name: "Self-replicating harvester probe", name_zh: "自复制采集探测器", wiki: false },
  ],

  // ─── Representational Art Lineage ───
  "rock-art-petroglyphs": [
    { type: "monument", name: "Tassili n'Ajjer", name_zh: "塔西利·恩·阿杰尔岩画", wiki: "Tassili n'Ajjer" },
    { type: "monument", name: "Bhimbetka rock shelters", name_zh: "比莫贝特卡岩画", wiki: "Bhimbetka rock shelters" },
    { type: "monument", name: "Côa Valley engravings", name_zh: "科阿河谷岩画", wiki: "Côa Valley Paleolithic Art" },
    { type: "monument", name: "Murujuga (Burrup Peninsula)", name_zh: "穆鲁加岩画", wiki: "Murujuga" },
    { type: "resource", name: "Petroglyph", name_zh: "岩刻", wiki: "Petroglyph" },
    { type: "resource", name: "San rock art", name_zh: "桑人岩画", wiki: "San rock art" },
  ],
  "mural-fresco": [
    { type: "monument", name: "Knossos throne-room frescoes", name_zh: "克诺索斯壁画", wiki: "Knossos" },
    { type: "monument", name: "Tomb of the Diver (Paestum)", name_zh: "潜水者之墓壁画", wiki: "Tomb of the Diver" },
    { type: "monument", name: "Pompeii frescoes", name_zh: "庞贝壁画", wiki: "Roman art" },
    { type: "monument", name: "Sistine Chapel ceiling", name_zh: "西斯廷教堂天顶画", wiki: "Sistine Chapel ceiling" },
    { type: "creative", name: "Scrovegni (Arena) Chapel", name_zh: "斯克罗维尼礼拜堂", wiki: "Scrovegni Chapel" },
    { type: "resource", name: "Buon fresco", name_zh: "湿壁画(buon fresco)", wiki: "Fresco" },
    { type: "resource", name: "Giornata", name_zh: "Giornata分日作画区", wiki: "Giornata" },
  ],
  "court-ensemble-music": [
    { type: "unit", name: "Lyres of Ur", name_zh: "乌尔的里拉琴", wiki: "Lyres of Ur" },
    { type: "work", name: "Hurrian Hymn No. 6", name_zh: "胡里安颂歌第六号", wiki: "Hurrian songs" },
    { type: "unit", name: "Ancient Egyptian harp", name_zh: "古埃及竖琴", wiki: "Music of ancient Egypt" },
    { type: "person", name: "Enheduanna (composer-priestess)", name_zh: "恩赫杜安娜", wiki: "Enheduanna" },
  ],
  "divine-kingship": [
    { type: "person", name: "Pharaoh", name_zh: "法老", wiki: "Pharaoh" },
    { type: "work", name: "Mandate of Heaven", name_zh: "天命", wiki: "Mandate of Heaven" },
    { type: "person", name: "Sapa Inca", name_zh: "印加最高君主", wiki: "Sapa Inca" },
    { type: "work", name: "Imperial cult of ancient Rome", name_zh: "罗马帝王崇拜", wiki: "Imperial cult of ancient Rome" },
    { type: "person", name: "Hammurabi (divine commission)", name_zh: "汉谟拉比", wiki: "Hammurabi" },
  ],
  "funerary-cult": [
    { type: "work", name: "Pyramid Texts", name_zh: "《金字塔铭文》", wiki: "Pyramid Texts" },
    { type: "work", name: "Egyptian Book of the Dead", name_zh: "《亡灵书》", wiki: "Book of the Dead" },
    { type: "resource", name: "Mummification", name_zh: "木乃伊化", wiki: "Mummy" },
    { type: "unit", name: "Shabti figurines", name_zh: "沙伯提俑", wiki: "Ushabti" },
    { type: "monument", name: "Valley of the Kings", name_zh: "帝王谷", wiki: "Valley of the Kings" },
    { type: "work", name: "Weighing of the Heart ritual", name_zh: "称心仪式", wiki: "Weighing of the Heart" },
  ],

  // ─── Renaissance Tools & Materials ───
  "cristallo-glass": [
    { type: "person", name: "Angelo Barovier", name_zh: "安杰洛·巴罗维耶", wiki: "Angelo Barovier" },
    { type: "monument", name: "Murano glassworks", name_zh: "穆拉诺玻璃作坊", wiki: "Murano glass" },
    { type: "resource", name: "Cristallo", name_zh: "Cristallo水晶玻璃", wiki: "Cristallo" },
    { type: "resource", name: "Lead glass (Ravenscroft)", name_zh: "铅玻璃(雷文斯克罗夫特)", wiki: "Lead glass" },
    { type: "org", name: "Compagnia di Saint-Gobain", name_zh: "圣戈班公司", wiki: "Saint-Gobain" },
  ],
  "slide-rule": [
    { type: "person", name: "William Oughtred", name_zh: "威廉·奥特雷德", wiki: "William Oughtred" },
    { type: "person", name: "John Napier", name_zh: "约翰·纳皮尔", wiki: "John Napier" },
    { type: "resource", name: "Logarithmic scale", name_zh: "对数标度", wiki: "Logarithmic scale" },
    { type: "monument", name: "Pickett N902-T (Apollo backup rule)", name_zh: "Pickett N902-T(阿波罗任务备用计算尺)", wiki: "Pickett (slide rule company)" },
    { type: "resource", name: "HP-35 calculator (replacement)", name_zh: "HP-35计算器(取代物)", wiki: "HP-35" },
  ],
  "mining-metallurgy": [
    { type: "person", name: "Georgius Agricola", name_zh: "格奥尔基乌斯·阿格里科拉", wiki: "Georgius Agricola" },
    { type: "creative", name: "De re metallica", name_zh: "《论冶金》(1556)", wiki: "De re metallica" },
    { type: "resource", name: "Stamp mill", name_zh: "捣矿机", wiki: "Stamp mill" },
    { type: "resource", name: "Cupellation", name_zh: "灰皿冶金法", wiki: "Cupellation" },
    { type: "resource", name: "Patio process (Hg amalgamation)", name_zh: "汞齐法", wiki: "Patio process" },
    { type: "monument", name: "Potosí silver mines", name_zh: "波托西银矿", wiki: "Potosí" },
  ],

  // ─── Energy: Hydro & Nuclear ───
  "hydroelectric-power": [
    { type: "monument", name: "Hoover Dam", name_zh: "胡佛大坝", wiki: "Hoover Dam" },
    { type: "monument", name: "Three Gorges Dam", name_zh: "三峡大坝", wiki: "Three Gorges Dam" },
    { type: "monument", name: "Itaipu Dam", name_zh: "伊泰普大坝", wiki: "Itaipu Dam" },
    { type: "monument", name: "Adams Power Plant (Niagara)", name_zh: "亚当斯电站(尼亚加拉)", wiki: "Adams Power Plant Transformer House" },
    { type: "resource", name: "Francis turbine", name_zh: "弗朗西斯水轮机", wiki: "Francis turbine" },
    { type: "resource", name: "Pelton wheel", name_zh: "佩尔顿水轮机", wiki: "Pelton wheel" },
    { type: "resource", name: "Kaplan turbine", name_zh: "卡普兰水轮机", wiki: "Kaplan turbine" },
    { type: "resource", name: "Pumped-storage hydroelectricity", name_zh: "抽水蓄能", wiki: "Pumped-storage hydroelectricity" },
  ],
  "uranium-enrichment": [
    { type: "person", name: "Gernot Zippe", name_zh: "格诺特·齐佩", wiki: "Gernot Zippe" },
    { type: "monument", name: "K-25 (Oak Ridge)", name_zh: "K-25工厂(橡树岭)", wiki: "K-25" },
    { type: "monument", name: "Y-12 calutrons", name_zh: "Y-12电磁分离器", wiki: "Y-12 National Security Complex" },
    { type: "org", name: "Urenco", name_zh: "Urenco铀浓缩公司", wiki: "Urenco Group" },
    { type: "resource", name: "Gas centrifuge", name_zh: "气体离心机", wiki: "Gas centrifuge" },
    { type: "resource", name: "Gaseous diffusion", name_zh: "气体扩散法", wiki: "Gaseous diffusion" },
    { type: "resource", name: "Highly enriched uranium", name_zh: "高浓缩铀", wiki: "Enriched uranium" },
    { type: "resource", name: "Treaty on the Non-Proliferation of Nuclear Weapons", name_zh: "《不扩散核武器条约》", wiki: "Treaty on the Non-Proliferation of Nuclear Weapons" },
  ],
  "charcoal-production": [
    { type: "resource", name: "Charcoal", name_zh: "木炭", wiki: "Charcoal" },
    { type: "resource", name: "Pyrolysis", name_zh: "热解", wiki: "Pyrolysis" },
    { type: "resource", name: "Charcoal kiln (clamp)", name_zh: "炭窑", wiki: "Charcoal kiln" },
    { type: "unit", name: "Collier (charcoal-burner)", name_zh: "烧炭工", wiki: "Charcoal burner" },
    { type: "resource", name: "Bellows (forced draught)", name_zh: "鼓风风箱", wiki: "Bellows" },
  ],
  "bellows": [
    { type: "resource", name: "Bag bellows (Egyptian)", name_zh: "皮囊风箱(古埃及)", wiki: "Bellows" },
    { type: "resource", name: "Double-acting piston bellows (Han)", name_zh: "双动活塞风箱(汉代)", wiki: "Bellows" },
    { type: "resource", name: "Tuyère", name_zh: "风口管", wiki: "Tuyère" },
    { type: "resource", name: "Trompe (water-aspirated bellows)", name_zh: "水力风箱(trompe)", wiki: "Trompe" },
    { type: "monument", name: "Catalan forge", name_zh: "加泰罗尼亚炼铁炉", wiki: "Catalan forge" },
  ],
  "whale-oil": [
    { type: "monument", name: "Nantucket whaling fleet", name_zh: "南塔基特捕鲸船队", wiki: "Whaling in the United States" },
    { type: "monument", name: "New Bedford whaling industry", name_zh: "新贝德福德捕鲸业", wiki: "New Bedford, Massachusetts" },
    { type: "creative", name: "Moby-Dick", name_zh: "《白鲸》", wiki: "Moby-Dick" },
    { type: "resource", name: "Spermaceti", name_zh: "鲸蜡(抹香鲸蜡)", wiki: "Spermaceti" },
