...
window.TECH_UNLOCKS = {
  ...
  "orbital-ring": [
    { type: "person", name: "Paul Birch", name_zh: "保罗·伯奇" },
    { type: "person", name: "Isaac Arthur (futurist)", name_zh: "艾萨克·亚瑟" },
    { type: "unit", name: "Skyhook (megastructure)", name_zh: "天钩" },
    { type: "unit", name: "Lofstrom loop", name_zh: "洛夫斯特罗姆环" },
  ],
