#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 4 fighter-aviation follow-ups added
after fifth-gen-fighter (Apr 2026).
Picks artifact / aircraft / scene articles per the no-portraits rule.
"""
...
TARGETS = [
    ("counter-stealth-radar",         "Nebo-M"),
    ("adaptive-cycle-engine",         "General Electric XA100"),
    ("collaborative-combat-aircraft", "Boeing MQ-28 Ghost Bat"),
    ("sixth-gen-fighter",             "Next Generation Air Dominance"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "sixth-gen aviation batch (Apr 2026)",
            }
            print(f"  [ok]       {tid:32} -> {art}")
