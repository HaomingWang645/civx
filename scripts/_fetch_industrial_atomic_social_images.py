#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 5 social/culture techs added to fill
gaps in Industrial and Atomic eras (May 2026).
Picks scene / iconic-work / institutional articles per the no-portraits rule.
"""
...
TARGETS = [
    ("realism-naturalism",  "Realism (arts)"),
    ("spectator-sports",    "Spectator sport"),
    ("modern-retail",       "Le Bon Marché"),
    ("mass-tourism",        "Thomas Cook & Son"),
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "industrial/atomic social batch (May 2026)",
            }
