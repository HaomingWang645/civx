#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 8 realistic-future techs."""
...
TARGETS = [
    ("senolytic-longevity-therapy", "Cellular senescence"),
    ("brain-brain-communication",   "Brain–computer interface"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "realistic-future addition",
            }
            print(f"  [ok]       {tid:38} -> {art}")
