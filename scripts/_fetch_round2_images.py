#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 6 round-2 techs (Apr 2026, second batch).
Avoids portrait-style lead images (per memory rule)."""
...
TARGETS = [
    ("codex",                "Codex"),
    ("crank-connecting-rod", "Crankshaft"),
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "round 2 batch (Apr 2026)",
            }
