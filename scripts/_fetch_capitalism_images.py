#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 3 capitalism-arc techs added May 2026:
property-rights, industrial-capitalism, globalization.
Picks book covers / scenes / institutional artifacts per the no-portraits rule.
"""
...
TARGETS = [
    ("property-rights",        "Two Treatises of Government"),
    ("industrial-capitalism",  "The Wealth of Nations"),
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "capitalism arc batch (May 2026)",
            }
