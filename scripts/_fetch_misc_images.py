#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 4 misc techs."""
...
TARGETS = [
    ...
    ("modern-olympics", "1896 Summer Olympics"),
    ("civil-aviation",  "Douglas DC-3"),
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "misc addition",
            }
