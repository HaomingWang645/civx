#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the two new mars-* techs created when we
split the original mars-colony node into a 3-stage progression."""
...
TARGETS = [
    ("mars-landing",  "Human mission to Mars"),
    ("mars-habitat",  "Mars Base Camp"),
    # mars-colony already had an image; we leave it as-is unless the existing
    # one is unsuitable for the new (narrower) "self-sustaining" framing.
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "mars colonization split (Apr 2026)",
            }
