#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the keystone techs added in Apr 2026:
cartography, postal-system, astrolabe, patent-system, stock-exchange,
aluminum-smelting, information-theory, operating-system, organ-transplant,
quantum-internet, refrigeration, game-theory, public-key-cryptography.

Picks artifact / diagram / iconic-work / scene articles to avoid portraits
(per the saved no-portraits rule).
"""
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "keystone techs batch (Apr 2026)",
            }
