#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 21 newly added techs (Apr 2026).
Avoids portrait-style lead images (per memory rule) by picking artifact /
diagram / event / iconic-work articles.
"""
...
TARGETS = [
    ("rockshelter-occupation", "Rock shelter"),
    ("cooperative-hunting",    "Schöningen spears"),
    ("early-bone-tools",       "Bone tool"),
    ("sling-stones",           "Sling (weapon)"),
    ("snares-traps",           "Trapping"),
    ("tailored-clothing",      "Sungir"),
    ("hide-tents",             "Tipi"),
    ("wool-textiles",          "Wool"),
    ("proto-cities",           "Çatalhöyük"),
    ("defensive-walls",        "Tower of Jericho"),
    ("tin-mining",             "Cassiterite"),
    ("weights-measures",       "Indus Valley civilisation"),
    ("parchment-vellum",       "Parchment"),
    ("theatre-drama",          "Theatre of ancient Greece"),
    ("polyphony-notation",     "Musical notation"),
    ("plate-armor",            "Plate armour"),
    ("electric-lighting",      "Incandescent light bulb"),
    ("submarine",              "Submarine"),
    ("synthetic-fibers",       "Nylon"),
    ("laser",                  "Laser"),
    ("parallel-compute-gpu",   "Graphics processing unit"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "new techs batch (Apr 2026)",
            }
