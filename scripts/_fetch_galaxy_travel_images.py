#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 4 galaxy-travel additions."""
...
TARGETS = [
    ...
    ("cryogenic-hibernation", "Cryonics"),
    ("kugelblitz-drive",      "Black hole"),
    ("cosmic-string-ftl",     "Wormhole"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "galaxy-travel batch (Apr 2026)",
            }
