#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 2 entropy/reversible-computing techs."""
...
TARGETS = [
    ("reversible-computing", "Quantum logic gate"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "entropy/reversible-computing addition",
            }
