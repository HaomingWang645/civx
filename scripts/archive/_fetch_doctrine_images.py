#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 12 doctrine techs (no portraits)."""
...
TARGETS = [
    ...
    ("castle-siege-doctrine",         "Krak des Chevaliers"),
    ("pike-square",                   "Tercio"),
    ("trench-warfare",                "Trench warfare"),
    ("combined-arms-warfare",         "Hundred Days Offensive"),
    ("blitzkrieg",                    "Blitzkrieg"),
    ("ballistic-missile-defense",     "Aegis Combat System"),
    ("stealth-aircraft-doctrine",     "Lockheed F-117 Nighthawk"),
    ("network-centric-warfare",       "Network-centric warfare"),
    ("layered-air-missile-defense",   "Iron Dome"),
    ("ai-decision-loop-compression",  "OODA loop"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "doctrine addition",
            }
