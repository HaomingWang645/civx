#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 8 future arts/entertainment techs."""
...
# Non-portrait targets where possible.
TARGETS = [
    ("bio-art",                       "BioArt"),
    ("mind-linked-collective-art",    "Brain–computer interface"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "future arts addition",
            }
