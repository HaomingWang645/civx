#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 10 physics/fusion techs (no portraits)."""
...
# All non-portrait subjects: instruments, diagrams, particles, materials.
TARGETS = [
    ("string-theory",            "Calabi–Yau manifold"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "physics addition",
            }
            print(f"  [ok]       {tid:28} -> {art}")
