#!/usr/bin/env python3
"""Fetch Wikipedia thumbnails for the 8 far-future 2500-2700 techs.
All targets are physics-concept articles, never personal portraits."""
...
TARGETS = [
    ("pan-galactic-coordination-ai",   "Multi-agent system"),
    ("strange-quark-matter",           "Neutron star"),
]
    ...
    for tid, article in TARGETS:
        ...
        try:
            ...
            manifest[tid] = {
                ...
                "status": "ok", "score": 0.9, "reason": "far-future 2500-2700 fill",
            }
